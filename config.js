...
module.exports = {
    ...
    SESSION: process.env.itz-me-malutty_CODE === undefined ? '' : process.env.itz-me-malutty_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖itz-me-malutty💖' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+917025994178' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'itz-me-malutty' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By itz-me-malutty' : process.env.ALL_CAPTION,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'itz-me-malutty_ser' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ itz-me-malutty ser ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'itz-me-malutty' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'itz-me-malutty🎗️/💝/✨/📝' : process.env.CMD_LIST,
